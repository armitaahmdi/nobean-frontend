            ...
            <div className="w-full relative">
                ...
                <div
                    ...
                    <div className="w-full flex justify-center">
                        <button className="w-3/4 glow-button bg-lightBlue text-white hover:bg-darkBlue rounded-[10px] py-[12px] text-[16px] leading-[1.2] tracking-[-0.02em] text-center align-middle font-bold"
                ...
                <div className="lg:hidden w-full mt-6 p-4 flex flex-col md:flex-row-reverse md:items-start gap-6 overflow-hidden">
                    ...
                    <div className="flex flex-col items-center justify-center w-full bg-white rounded-[20px] mt-2 p-4 shadow-md">
                        ...
                        <Button
                            ...
                            color="blue"
                            onClick={handleStartClick}
                            className="w-full glow-button  bg-lightBlue text-white hover:bg-darkBlue rounded-[5px] my-3 py-2"
                        >
                            {translate.startfree}
                        </Button>
